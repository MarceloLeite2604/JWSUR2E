 ...
 * 
 */
@WebServiceClient(name = "SkiImageServiceService", targetNamespace = "http://images.acaosistemas.com.br/", wsdlLocation = "http://10.0.50.89:9876/ski?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SKIIMAGESERVICESERVICE_QNAME = new QName("http://images.acaosistemas.com.br/", "SkiImageServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.0.50.89:9876/ski?wsdl");
    ...
    public SkiImageService getSkiImageServicePort() {
        return super.getPort(new QName("http://images.acaosistemas.com.br/", "SkiImageServicePort"), SkiImageService.class);
    }
    ...
    public SkiImageService getSkiImageServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://images.acaosistemas.com.br/", "SkiImageServicePort"), SkiImageService.class, features);
    }
