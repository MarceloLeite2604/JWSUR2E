 ...
 * generated in the br.com.acaosistemas.randasyncclient package. 
...
public class ObjectFactory {
    ...
    private final static QName _Next1_QNAME = new QName("http://rand.acaosistemas.com.br/", "next1");
    private final static QName _NextNResponse_QNAME = new QName("http://rand.acaosistemas.com.br/", "nextNResponse");
    private final static QName _Next1Response_QNAME = new QName("http://rand.acaosistemas.com.br/", "next1Response");
    private final static QName _NextN_QNAME = new QName("http://rand.acaosistemas.com.br/", "nextN");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.com.acaosistemas.randasyncclient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rand.acaosistemas.com.br/", name = "next1")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rand.acaosistemas.com.br/", name = "nextNResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rand.acaosistemas.com.br/", name = "next1Response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rand.acaosistemas.com.br/", name = "nextN")
