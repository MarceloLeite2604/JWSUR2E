 ...
 * 
 */
@WebServiceClient(name = "EchoService", targetNamespace = "http://echo.acaosistemas.com.br/", wsdlLocation = "http://10.0.50.89:9876/echo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ECHOSERVICE_QNAME = new QName("http://echo.acaosistemas.com.br/", "EchoService");
    ...
    public Echo getEchoPort() {
        return super.getPort(new QName("http://echo.acaosistemas.com.br/", "EchoPort"), Echo.class);
    }
    ...
    public Echo getEchoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://echo.acaosistemas.com.br/", "EchoPort"), Echo.class, features);
    }
