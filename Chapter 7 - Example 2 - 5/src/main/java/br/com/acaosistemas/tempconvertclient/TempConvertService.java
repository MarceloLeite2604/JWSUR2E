 ...
 * 
 */
@WebServiceClient(name = "TempConvertService", targetNamespace = "http://tempconvert.acaosistemas.com.br/", wsdlLocation = "http://10.0.50.89:8080/tempconvert?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEMPCONVERTSERVICE_QNAME = new QName("http://tempconvert.acaosistemas.com.br/", "TempConvertService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.0.50.89:8080/tempconvert?wsdl");
    ...
    public TempConvert getTempConvertPort() {
        return super.getPort(new QName("http://tempconvert.acaosistemas.com.br/", "TempConvertPort"), TempConvert.class);
    }
    ...
    public TempConvert getTempConvertPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempconvert.acaosistemas.com.br/", "TempConvertPort"), TempConvert.class, features);
    }
