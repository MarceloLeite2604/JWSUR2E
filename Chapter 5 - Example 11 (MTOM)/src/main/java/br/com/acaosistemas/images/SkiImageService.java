...
/*
 * Marcelo Leite - No caso da publicação do serviço através de 
 * Endpoint, o arquivo WSDL deve estar na pasta raiz dos fontes.
 * Se o arquivo for colocado em outra pasta ou dentro de uma 
 * package, ao executar o programa ocorrerá o erro "[failed to 
 * localize] cannot.load.wsdl", mesmo que sua localização esteja 
 * correta no atributo "wsdlLoation".
 */
