...
public class HttpsPublisher {
	...
	public static void main(String[] args) {
		...
		new HttpsPublisher().init(args[0], args[1]);
	...
	// The handle method is called on a particular request context, in this case
	// on any request to the server that ends with /<uri>.
