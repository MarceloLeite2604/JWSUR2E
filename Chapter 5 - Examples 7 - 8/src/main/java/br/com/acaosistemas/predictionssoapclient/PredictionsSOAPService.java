 ...
 * 
 */
@WebServiceClient(name = "PredictionsSOAPService", targetNamespace = "http://predictionssoap.acaosistemas.com.br/", wsdlLocation = "http://localhost:8080/predictionssoap?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PREDICTIONSSOAPSERVICE_QNAME = new QName("http://predictionssoap.acaosistemas.com.br/", "PredictionsSOAPService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/predictionssoap?wsdl");
    ...
    public PredictionsSOAP getPredictionsSOAPPort() {
        return super.getPort(new QName("http://predictionssoap.acaosistemas.com.br/", "PredictionsSOAPPort"), PredictionsSOAP.class);
    }
    ...
    public PredictionsSOAP getPredictionsSOAPPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://predictionssoap.acaosistemas.com.br/", "PredictionsSOAPPort"), PredictionsSOAP.class, features);
    }
