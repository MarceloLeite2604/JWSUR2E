 ...
 * 
 */
@WebServiceClient(name = "EchoService", targetNamespace = "http://echoService.acaosistemas.com.br/", wsdlLocation = "http://10.0.50.89:9876/echo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ECHOSERVICE_QNAME = new QName("http://echoService.acaosistemas.com.br/", "EchoService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.0.50.89:9876/echo?wsdl");
    ...
    public Echo getEchoPort() {
        return super.getPort(new QName("http://echoService.acaosistemas.com.br/", "EchoPort"), Echo.class);
    }
    ...
    public Echo getEchoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://echoService.acaosistemas.com.br/", "EchoPort"), Echo.class, features);
    }
