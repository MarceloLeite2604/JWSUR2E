...
/*
 * Marcelo Leite - Quando o arquivo WAR for publicado, o que estiver 
 * na pasta "WEB-INF/wsdl" será publicado como o "WSDL" do serviço, 
 * independente do atributo "wsdlLocation" estar informado ou não! 
 */
@WebService(wsdlLocation = "ski-mtom.wsdl")
