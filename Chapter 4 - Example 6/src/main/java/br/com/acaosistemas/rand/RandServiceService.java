 ...
 * 
 */
@WebServiceClient(name = "RandServiceService", targetNamespace = "http://rand.acaosistemas.com.br/", wsdlLocation = "http://10.0.50.89:8080/rand?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RANDSERVICESERVICE_QNAME = new QName("http://rand.acaosistemas.com.br/", "RandServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.0.50.89:8080/rand?wsdl");
    ...
    public RandService getRandServicePort() {
        return super.getPort(new QName("http://rand.acaosistemas.com.br/", "RandServicePort"), RandService.class);
    }
    ...
    public RandService getRandServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://rand.acaosistemas.com.br/", "RandServicePort"), RandService.class, features);
    }
